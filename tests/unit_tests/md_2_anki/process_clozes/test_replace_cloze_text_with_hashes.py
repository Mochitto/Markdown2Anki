...
class TestGetClozes:
    ...
    def test_basic_case(self):
        ...
        hashed_clozes = {'HIIDAJIGJADFBDBJJDF': ('1', 'clozes'), 'ZEJDDDHDEBDEICGIHBGF': ('2', 'cloze')}

        cleaned_content = clozes.clean_code_from_clozes(content)
        hashed_content = clozes.replace_cloze_text_with_hashes(cleaned_content, hashed_clozes)
