...
class TestFormatTab:
    def test_good_case(self):
        tab: HTMLTab = {"tab_label": "A label", "tab_body": "<p>Hello world</p>"}
        expected_tab = (
            '<section class="tab">'
    ...
    def test_missing_label(self):
        tab: HTMLTab = {"tab_label": "", "tab_body": "<p>Hello world</p>"}
        with pytest.raises(CardError):
            format_tab(tab)

    def test_missing_body(self):
        tab: HTMLTab = {"tab_label": "A label", "tab_body": ""}
        with pytest.raises(CardError):
            format_tab(tab)

    def test_empty_tab(self):
        tab: HTMLTab = {"tab_label": "", "tab_body": ""}
        with pytest.raises(CardError):
            format_tab(tab)
