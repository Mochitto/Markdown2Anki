...
class TestFindImagePath:
    ...
    def good_images(self, assets_images_path):
        images_file_names = {
                ...
                "i_am_a_forest_fire.jpeg": assets_images_path / Path("MORE", "YES_ME", "i_am_a_forest_fire.jpeg"),
    ...
    def nooti_images(self, assets_images_path):
        images_file_names = {
                "mmmm.jpg": assets_images_path / Path("MORE", "exclude_me_too", "mmmm.jpeg"),
    ...
    def test_images_finding(self, assets_images_path, good_images, nooti_images):
        ...
        for nooti_image in list(nooti_images.keys()):
            nooti_image_path = find_image_path(nooti_image, assets_images_path, folders_to_exclude)
