...
def get_swapped_tabs(card_data) -> CardTypes.CardWithTabs:
    ...
    swapped_left_tabs = swap_tabs(
        front_left_tabs, back_left_tabs, left_tabs_to_swap, "left_tabs"
    )
    ...
    swapped_right_tabs = swap_tabs(
        front_right_tabs, back_right_tabs, right_tabs_to_swap, "right_tabs"
    )
...
def swap_tabs(
    ...
    if tab_indices_to_swap:
        ...
        back_tabs_remaining = [
            tab
            for tab_index, tab in enumerate(back_tabs)
